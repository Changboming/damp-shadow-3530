...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/damp-shadow-3530
```

A live public deployment of this template is available at [https://damp-shadow-3530.templates.workers.dev](https://damp-shadow-3530.templates.workers.dev)
